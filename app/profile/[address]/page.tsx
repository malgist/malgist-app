    ...
    <>
      <div className="max-w-6xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="p-5 sm:p-6 lg:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 via-emerald-500/10 to-emerald-500/10 border border-emerald-500/20"
        >
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-10">
            {/* Avatar */}
            <div className="relative group shrink-0">
              <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden border-4 border-emerald-500/20">
                <Image
              ...
              {profileData.user.isVerified && (
                <div className="absolute -bottom-1 -right-1 w-7 h-7 sm:w-8 sm:h-8 bg-blue-500 rounded-full flex items-center justify-center border-4 border-[#0a0a0a]">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                <span className="text-sm truncate">{profileData.user.address}</span>
                {copiedAddress ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4" />}
              </button>
              <p className="text-zinc-300 max-w-2xl mb-4 text-sm sm:text-base">{profileData.user.bio}</p>
            ...
            <div className="grid grid-cols-2 gap-3 w-full sm:w-auto">
              <div className="text-center p-3 sm:p-4 rounded-xl bg-[#1a1a1a]/50">
                <p className="text-xl sm:text-2xl font-bold text-white">{profileData.stats.totalFollowers}</p>
                <p className="text-xs sm:text-sm text-[#a1a1a1]">Followers</p>
              </div>
              <div className="text-center p-3 sm:p-4 rounded-xl bg-[#1a1a1a]/50">
                <p className="text-xl sm:text-2xl font-bold text-green-400">{profileData.stats.averageApy}%</p>
                <p className="text-xs sm:text-sm text-[#a1a1a1]">Avg APY</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <motion.div
            ...
            className="p-4 sm:p-5 lg:p-6 rounded-xl bg-[#1a1a1a] border border-[#262626]"
          >
          ...
          >
            ...
            <p className="text-xl sm:text-2xl font-bold text-white">{profileData.stats.totalStrategies}</p>
        ...
        {/* Strategies List */}
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">Published Strategies</h2>
            ...
            {profileData.strategies.map((strategy, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-4 sm:p-5 lg:p-6 rounded-xl bg-[#1a1a1a] border border-[#262626] hover:border-emerald-500 transition-all cursor-pointer group"
                >
