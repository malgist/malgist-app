...
import ActivePositionsDonut from '@/components/portfolio/ActivePositionsDonut';
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Portfolio Performance & Active Positions - Side by Side Layout */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {/* Portfolio Chart - Takes 3/4 width on large screens */}
          <div className="lg:col-span-3 rounded-2xl bg-[#1a1a1a] border border-[#262626] overflow-hidden">
            {/* Header */}
          ...
          {/* Active Positions Donut Chart - Takes 1/4 width on large screens */}
          <div className="lg:col-span-1 rounded-2xl bg-[#1a1a1a] border border-[#262626] p-6">
            <ActivePositionsDonut positions={mockPositions} />
          </div>
        </motion.div>

        {/* Active Positions List - Full Width Below */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
